"""POST /crm-setup Lambda stub (Phase 1 infrastructure placeholder)."""
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """Return a healthy JSON response for the CRM setup endpoint.
    ...
    """
    _ = event  # Reserved for future HubSpot CRM setup inputs
    _ = context  # Reserved for future logging and tracing
    body = {"status": "ok", "handler": "crm_setup"}  # Minimal stub payload
